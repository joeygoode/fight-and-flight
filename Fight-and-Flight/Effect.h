...
public:
	...
	bool Initialize(const string& name, ID3D10Effect* pDXEffect, ID3D10EffectTechnique* pDXTechnique, D3D10_TECHNIQUE_DESC DXTechDesc, _In_ const vector<string>& names, _In_ const vector<string>& types);
private:
