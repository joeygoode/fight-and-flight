...
#include <vector>
using namespace std;
CDirectXManager::CDirectXManager(void)
{
	pD3DDevice = NULL;
	pSwapChain = NULL;
...
*******************************************************************/
bool CDirectXManager::Initialize( HWND* hW )
{
	//window handle
	hWnd = hW;
	...
	vector<ID3D10ShaderResourceView*> textureSRV;
	...
	for ( int i=0; i < (int) filenames.size(); i++ )
	{
		...
		//set texture
	pTextureSR->SetResource( textureSRV[0] );
...
* Scene Renderer
*******************************************************************/
void CDirectXManager::RenderScene()
{
	//clear scene
...
* Fatal Error Handler
*******************************************************************/
bool CDirectXManager::FatalError(LPCSTR msg)
{
